 ...
 * Use the {@link TrackingCustomerFragment#newInstance} factory method to
...
public class TrackingCustomerFragment extends Fragment {
    ...
    public TrackingCustomerFragment() {
    ...
    public static TrackingCustomerFragment newInstance(String param1, String param2) {
        TrackingCustomerFragment fragment = new TrackingCustomerFragment();
